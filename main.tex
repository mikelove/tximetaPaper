...
or Alevin quantification tools \cite{sailfish,salmon,alevin},
...
\begin{flushleft}
  ...
  version number, and so not stable releases.
\end{flushleft}
\label{tab1}
\end{table}
