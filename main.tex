...
Gene expression quantification with RNA sequencing is a common
...
location of the genes in particular genome assembly. Often it is
difficult for this critical metadata to be found for public datasets,
and manually curating this information within a lab subjects the
process to human error. We describe a solution for this problem,
whereby we embed a checksum of the reference sequences in the output
data during expression quantification, and then we use this checksum
for identification and automatic attachment of the correct metadata
when the dataset is loaded into R for statistical analysis. We feel
this paradigm of embedded checksums and subsequent metadata retrieval
will prove useful in other computational biology contexts as well.
