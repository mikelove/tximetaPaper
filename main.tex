...
\begin{figure}
  ...
  \caption{
    ...
    SummarizedExperiment with reference transcript provenance
...
\begin{flushleft}
  ...
  accurate RNA-seq quantification; $\dagger$ - RefSeq releases p13 and
  p6 for human and mouse respectively are currently \textit{latest},
  which means they are subject to updates under the same release
  number, and so not stable releases.
\end{flushleft}
\label{tab1}
\end{table}
...
\begin{verbatim}
    ...
    ##                       <Rle> <IRanges>  <Rle> |
    ##   TRINITY_DN114791_c0_g1_i1    1-2308      + |
    ##   TRINITY_DN114724_c0_g2_i1     1-635      - |
    ##        tx_id
    ##    <integer>
    ##         1290
    ##         1283
...
\citep{bioc,ensembldb,biocfilecache,granges}. The tximeta package is
...
\begin{itemize}
  \item De novo transcriptome assembly (FASTA) \href{https://doi.org/10.5281/zenodo.1486276}{DOI: 10.5281/zenodo.1486276}.
  \item Annotation file (GFF3) \href{https://doi.org/10.5281/zenodo.2226742}{DOI: 10.5281/zenodo.2226742},
\end{itemize}
